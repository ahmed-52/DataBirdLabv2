            ...
            <div className="fixed right-0 top-0 bottom-0 w-96 bg-white outline-none z-[500] border-l border-zinc-200 transform transition-transform duration-300 overflow-y-auto">
                ...
                <div className="p-5 space-y-6">
                    <div className="p-3 bg-zinc-50 border border-zinc-200 rounded-sm text-xs text-zinc-600">
                        <h4 className="font-bold text-zinc-800 mb-1 font-display uppercase">Mission Parameters</h4>
                    ...
                    {!isLoadingDetections && allDetections.length > 0 && (
                        <div className="space-y-2">
                            <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest border-b border-zinc-100 pb-1">Taxonomy Manifest</h4>
                    ...
                    <div>
                        ...
                        {isLoadingDetections ? (
                            <div className="text-center py-8">
                                <Activity className="animate-spin mx-auto text-zinc-300 mb-2" size={16} />
                                <p className="text-[10px] font-mono text-zinc-400">FETCHING_TELEMETRY...</p>
                            </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    {(data as any).survey_name && (
                        <div className="col-span-2 p-2.5 bg-zinc-50 rounded-sm border border-zinc-200">
                            <div className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider mb-1">Source Mission</div>
