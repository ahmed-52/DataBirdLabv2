          ...
          <Table>
            <TableHeader className="bg-zinc-50">
              <TableRow className="border-b border-zinc-200">
                ...
                <SortHeader field="species">Species</SortHeader>
                ...
                <TableHead className="h-10 text-[10px] uppercase font-bold tracking-wider text-zinc-500 font-display bg-zinc-50">Survey</TableHead>
